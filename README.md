...
5. **Configure environment variables - IMPORTANT!**
    ...
    Repacel *sample.env* file with proper *.env* containing OPEN_API_KEY (optionally ANTHROPIC_API_KEY, but then change model in *agentslib.py* settings)
...
7. **POST log to */logs/ingest* endpoint and refresh UI web page (Optional)**
