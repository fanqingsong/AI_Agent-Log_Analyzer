# main_postgres.py
"""
FastAPI chat app using PostgreSQL for chat history storage (async, production-ready).
Replace DATABASE_URL with your actual PostgreSQL credentials.
Install dependencies:
    pip install fastapi uvicorn databases asyncpg sqlalchemy logfire pydantic_ai
"""
...
if __name__ == '__main__':
    import uvicorn
    uvicorn.run("main_postgres:app", host="127.0.0.1", port=8000, reload=True)
    # In cmd: uvicorn main_postgres:app --host 127.0.0.1 --port 8000 --reload
